...
if [ "$(ls -A /work/graalvm-ee)" ]; then
    ...
    jabba install graalvm-ee@21.1.0-java11=tgz+file:///work/graalvm-ee/graalvm-ee-java11-linux-amd64-21.1.0.tar.gz
    jabba use graalvm-ee@21.1.0-java11
    gu -L install /work/graalvm-ee/native-image-installable-svm-svmee-java11-linux-amd64-21.1.0.jar
fi